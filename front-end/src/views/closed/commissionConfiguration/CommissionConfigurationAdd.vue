<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-4 text-xs">
      <h2 class="font-semibold mb-3 text-base">Add Commission Configuration</h2>
      ...
      <div class="flex justify-end gap-2 mt-4">
        ...
        <button @click="save" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded">
          Save
        </button>
      </div>
    </div>
