      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <button
            ...
            class="bg-green-500 text-white font-medium px-4 py-2 rounded-md shadow-md hover:bg-green-600 transition duration-150 ease-in-out flex items-center space-x-1"
          >
