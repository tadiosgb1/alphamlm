<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-80 p-4 text-xs">
      <h2 class="font-semibold mb-3">Edit Package</h2>
...
export default {
  ...
  data(){ return { form:{ id:null, name:'', package_type:'product', price:'', cost:'', category:0 } }; },
  watch:{
    packageData:{ immediate:true, handler(val){ if(val) this.form={...val}; } }
  },
  methods:{
    async updatePackage(){
