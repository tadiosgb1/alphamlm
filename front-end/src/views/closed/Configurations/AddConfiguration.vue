<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg w-96 p-4 text-xs overflow-y-auto max-h-[90vh]">
      <h2 class="font-semibold mb-3">Add Configuration</h2>
...
export default {
  data(){ return {
    form:{
      investment_amount:'', housing_or_car_investment:'', sacco:'',
      company_revenue_product_percentage:'', product_disrtribution_reward_percentage:'',
      company_revenue_training_percentage:'', training_distribution_reward_percentage:'',
      service_charge:''
    }
  }; },
  methods:{
    async saveConfig(){
      try{
        await this.$apiPost('/post_configuration', this.form);
